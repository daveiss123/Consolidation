		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="post" action="php/connexion/insertionenbdd.php">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="veuillez renseigner votre nom">
						<input class="input100" type="text" name="nom" placeholder="Nom">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-16" data-validate="veuillez renseigner votre prénom">
						<input class="input100" type="text" name="prenom" placeholder="Prénom">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-16" data-validate="veuillez renseigner votre date d'anniversaire">
						<input class="input100" type="date" name="date_de_naissance" >
						<span class="focus-input100"></span>
					</div>
